...
export const fetchData = (searchQuery: string, cursor?: string) =>
async (dispatch: AppDispatch): Promise<void> => {
    try {
        ...
        dispatch(slice.actions.fetchDataSuccess({ repositories: nodes, repositoryCount, endCursor, hasNextPage, edges }));
    } catch (error) {
